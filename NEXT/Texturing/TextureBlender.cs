...
namespace SingleTrainTrack.NEXT.Texturing
{
    public partial class TextureBlender : ITextureProvider
    {
        ...
        {
            AddComponent(new TextureBlender.AlphaComponent(
                () => alphaTexture,
                position: position));
            return this;
        }
